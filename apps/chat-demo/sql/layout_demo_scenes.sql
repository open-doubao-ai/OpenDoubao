...
(1601, 82001, 1401, '30 天英语口语入门', '林夏', 'https://picsum.photos/id/24/800/450', '从日常对话开始，带你开口说英语。', 30, 1280, '2026-08-02 09:00:00'),
(1602, 82002, 1402, '零基础 Python 实战', '周启', 'https://picsum.photos/id/0/800/450', '用小项目学会变量、函数和接口调用。', 24, 2560, '2026-08-03 09:00:00'),
(1603, 82001, 1403, '考研英语真题精讲', '陈砚', 'https://picsum.photos/id/180/800/450', '近五年阅读与作文拆解。', 18, 980, '2026-08-04 09:00:00'),
(1604, 82002, 1404, '短视频剪辑入门', '阿凯', 'https://picsum.photos/id/96/800/450', '字幕、转场、BGM 一次讲清。', 12, 1760, '2026-08-05 09:00:00'),
(1605, 82001, 1405, '儿童拼音启蒙课', '苗苗', 'https://picsum.photos/id/1015/800/450', '游戏化认读，适合 4–6 岁。', 16, 640, '2026-08-06 09:00:00'),
(1606, 82002, 1406, '吉他弹唱 21 天', '老周', 'https://picsum.photos/id/39/800/450', '三和弦就能唱完一首歌。', 21, 890, '2026-08-07 09:00:00')
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `categoryId`=VALUES(`categoryId`);

INSERT INTO `Book` (`id`,`userId`,`categoryId`,`title`,`author`,`cover`,`content`,`publisher`,`viewCount`,`date`) VALUES
(1701, 82001, 1411, '海边的清晨', '苏晚', 'https://picsum.photos/id/24/800/450', '一部关于离家与归来的长篇小说。', '春山文艺', 2100, '2026-08-02 10:00:00'),
(1702, 82002, 1412, '小团队增长手册', '何川', 'https://picsum.photos/id/20/800/450', '把增长拆成可执行的周计划。', '远帆出版', 1560, '2026-08-03 10:00:00'),
(1703, 82001, 1413, '长安夜市考', '裴衡', 'https://picsum.photos/id/1019/800/450', '从夜市看一座城的生活史。', '古籍新社', 870, '2026-08-04 10:00:00'),
(1704, 82002, 1414, '给所有人的电路', '韩石', 'https://picsum.photos/id/0/800/450', '用生活例子讲清基础电路。', '工科读本', 640, '2026-08-05 10:00:00'),
(1705, 82001, 1415, '家庭收纳 100 问', '米儿', 'https://picsum.photos/id/1078/800/450', '小户型也能腾出一间房。', '生活家', 1320, '2026-08-06 10:00:00'),
(1706, 82002, 1416, '月亮邮局', '小橙', 'https://picsum.photos/id/1015/800/450', '写给睡前的十二封信。', '童心社', 980, '2026-08-07 10:00:00')
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `categoryId`=VALUES(`categoryId`);

INSERT INTO `Comic` (`id`,`userId`,`categoryId`,`title`,`author`,`cover`,`content`,`chapterCount`,`viewCount`,`date`) VALUES
(1801, 82001, 1421, '少年剑客行', '墨白', 'https://picsum.photos/id/96/800/450', '一把断剑，一座江湖。', 86, 4200, '2026-08-02 11:00:00'),
(1802, 82002, 1422, '便利店恋爱日志', '浅浅', 'https://picsum.photos/id/64/800/450', '夜班遇见的那个人。', 42, 3100, '2026-08-03 11:00:00'),
(1803, 82001, 1423, '星海旅团', '南风', 'https://picsum.photos/id/1016/800/450', '跨星系寻找失落的故乡。', 60, 2800, '2026-08-04 11:00:00'),
(1804, 82002, 1424, '合租的猫', '土豆', 'https://picsum.photos/id/106/800/450', '四个人和一只不讲理的猫。', 28, 1900, '2026-08-05 11:00:00'),
(1805, 82001, 1425, '机甲晨星', '铁木', 'https://picsum.photos/id/160/800/450', '废墟上的第一台自制机甲。', 55, 2600, '2026-08-06 11:00:00'),
(1806, 82002, 1426, '雾城谜案', '冷杉', 'https://picsum.photos/id/60/800/450', '每场雨都会带走一条线索。', 33, 1700, '2026-08-07 11:00:00')
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `categoryId`=VALUES(`categoryId`);

INSERT INTO `Local` (`id`,`userId`,`categoryId`,`title`,`author`,`cover`,`content`,`address`,`price`,`viewCount`,`date`) VALUES
(1901, 82001, 1431, '两小时深度保洁', '洁雅家政', 'https://picsum.photos/id/201/800/450', '厨房卫生间重点，自带工具。', '城西·桂花路', 168.00, 320, '2026-08-02 12:00:00'),
(1902, 82002, 1432, '空调清洗上门', '快修哥', 'https://picsum.photos/id/180/800/450', '挂机柜机都做，当天可约。', '城东·望江街', 128.00, 210, '2026-08-03 12:00:00'),
(1903, 82001, 1433, '同城文件闪送', '小跑腿', 'https://picsum.photos/id/1018/800/450', '5 公里内 40 分钟达。', '全市', 25.00, 540, '2026-08-04 12:00:00'),
(1904, 82002, 1434, '剪发+护理套餐', '青木造型', 'https://picsum.photos/id/64/800/450', '设计师剪裁，含基础护理。', '湖滨银泰 3F', 188.00, 160, '2026-08-05 12:00:00'),
(1905, 82001, 1435, '密室逃脱双人票', '迷雾馆', 'https://picsum.photos/id/1016/800/450', '周末场可改期一次。', '文创园 B2', 158.00, 90, '2026-08-06 12:00:00'),
(1906, 82002, 1436, '社区代缴水电', '便民站', 'https://picsum.photos/id/292/800/450', '代缴代办，收 2 元服务费。', '翠苑一区门口', 2.00, 410, '2026-08-07 12:00:00')
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `categoryId`=VALUES(`categoryId`);

INSERT INTO `Recipe` (`id`,`userId`,`categoryId`,`title`,`author`,`cover`,`content`,`minutes`,`viewCount`,`date`) VALUES
(2001, 82001, 1441, '番茄炒蛋不会失败版', '阿圆', 'https://picsum.photos/id/292/800/450', '先炒蛋再烩番茄，汤汁挂住。', 15, 2400, '2026-08-02 13:00:00'),
(2002, 82002, 1442, '原味磅蛋糕', '小烘', 'https://picsum.photos/id/1080/800/450', '室温黄油是关键。', 70, 980, '2026-08-03 13:00:00'),
(2003, 82001, 1443, '葱油拌面', '老街口', 'https://picsum.photos/id/225/800/450', '热油浇葱蒜，一碗就够。', 20, 1560, '2026-08-04 13:00:00'),
(2004, 82002, 1444, '鸡胸生菜卷', '轻食记', 'https://picsum.photos/id/488/800/450', '低油煎鸡胸，酸奶酱。', 25, 720, '2026-08-05 13:00:00'),
(2005, 82001, 1445, '冰美式在家做', '杯测', 'https://picsum.photos/id/431/800/450', '1:2 浓缩加冰块。', 8, 640, '2026-08-06 13:00:00'),
(2006, 82002, 1446, '巷口黄鱼面馆', '探店员', 'https://picsum.photos/id/42/800/450', '汤鲜，面偏软，建议配小黄鱼。', 0, 880, '2026-08-07 13:00:00')
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `categoryId`=VALUES(`categoryId`);

INSERT INTO `Trip` (`id`,`userId`,`categoryId`,`title`,`author`,`cover`,`content`,`destination`,`days`,`viewCount`,`date`) VALUES
(2101, 82001, 1451, '大理慢走四日', '路人甲', 'https://picsum.photos/id/1016/800/450', '洱海骑行 + 古城夜市，不赶行程。', '大理', 4, 1880, '2026-08-02 14:00:00'),
(2102, 82002, 1452, '大阪美食三日', '阿食', 'https://picsum.photos/id/1015/800/450', '心斋桥到黑门市场的走路路线。', '大阪', 3, 2100, '2026-08-03 14:00:00'),
(2103, 82001, 1453, '莫干山周末', '山风', 'https://picsum.photos/id/1036/800/450', '民宿泡汤，第二天再上山。', '莫干山', 2, 960, '2026-08-04 14:00:00'),
(2104, 82002, 1454, '湖景亲子民宿', '安安', 'https://picsum.photos/id/164/800/450', '带滑梯的院子，含早餐。', '千岛湖', 2, 740, '2026-08-05 14:00:00'),
(2105, 82001, 1455, '园林联票攻略', '小导', 'https://picsum.photos/id/28/800/450', '拙政园+狮子林一天走完。', '苏州', 1, 1320, '2026-08-06 14:00:00'),
(2106, 82002, 1456, '桂林阳朔六日', '背包客', 'https://picsum.photos/id/29/800/450', '漓江、西街、遇龙河分段走。', '桂林', 6, 1540, '2026-08-07 14:00:00')
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `categoryId`=VALUES(`categoryId`);

INSERT INTO `Sport` (`id`,`userId`,`categoryId`,`title`,`author`,`cover`,`content`,`league`,`viewCount`,`date`) VALUES
(2201, 82001, 1461, '夜场逆转：补时绝杀', '球场记', 'https://picsum.photos/id/28/800/450', '主队 2-1 完成翻盘。', '中超', 3200, '2026-08-02 15:00:00'),
(2202, 82002, 1462, '夏季联赛新秀观察', '篮下', 'https://picsum.photos/id/73/800/450', '三名后卫的投射数据对比。', 'CBA', 2100, '2026-08-03 15:00:00'),
(2203, 82001, 1463, '世锦赛首日看点', '综合台', 'https://picsum.photos/id/76/800/450', '游泳与田径同一晚开赛。', '世锦赛', 980, '2026-08-04 15:00:00'),
(2204, 82002, 1464, '城市半马配速建议', '跑者', 'https://picsum.photos/id/66/800/450', '按完赛目标拆 5 公里配速。', '路跑', 760, '2026-08-05 15:00:00'),
(2205, 82001, 1465, '奥运周期选拔名单', '观察员', 'https://picsum.photos/id/1011/800/450', '新增两名年轻选手入围。', '奥运', 1500, '2026-08-06 15:00:00'),
(2206, 82002, 1466, '球迷观赛公约更新', '社群', 'https://picsum.photos/id/1012/800/450', '客场远征拼车与文明观赛。', '球迷会', 430, '2026-08-07 15:00:00')
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `categoryId`=VALUES(`categoryId`);

INSERT INTO `Baby` (`id`,`userId`,`categoryId`,`title`,`author`,`cover`,`content`,`monthAge`,`viewCount`,`date`) VALUES
(2301, 82001, 1471, '孕中期散步怎么走', '禾禾', 'https://picsum.photos/id/1015/800/450', '饭后 20 分钟，避开正午。', 20, 860, '2026-08-02 16:00:00'),
(2302, 82002, 1472, '6 月龄辅食第一口', '厨房妈妈', 'https://picsum.photos/id/292/800/450', '米粉+一种蔬菜，观察三天。', 6, 1240, '2026-08-03 16:00:00'),
(2303, 82001, 1473, '手指谣怎么带', '早教社', 'https://picsum.photos/id/24/800/450', '睡前 5 分钟就够。', 12, 540, '2026-08-04 16:00:00'),
(2304, 82002, 1474, '学步车要不要买', '测评组', 'https://picsum.photos/id/201/800/450', '更建议学步推车和防撞条。', 10, 710, '2026-08-05 16:00:00'),
(2305, 82001, 1475, '周末公园半日', '爸爸档', 'https://picsum.photos/id/1016/800/450', '沙坑+绘本，回家午睡。', 24, 390, '2026-08-06 16:00:00'),
(2306, 82002, 1476, '疫苗日提醒清单', '社区护士', 'https://picsum.photos/id/180/800/450', '空腹、带手册、观察 30 分钟。', 8, 980, '2026-08-07 16:00:00')
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `categoryId`=VALUES(`categoryId`);

INSERT INTO `Workout` (`id`,`userId`,`categoryId`,`title`,`author`,`cover`,`content`,`duration`,`kcal`,`viewCount`,`date`) VALUES
(2401, 82001, 1481, '上肢力量 30 分钟', '岩教练', 'https://picsum.photos/id/66/800/450', '推、拉、核心各 3 组。', 30, 220, 640, '2026-08-02 17:00:00'),
(2402, 82002, 1482, '居家 HIIT 20 分钟', '燃', 'https://picsum.photos/id/28/800/450', '40 秒练 20 秒歇，循环 4 轮。', 20, 180, 890, '2026-08-03 17:00:00'),
(2403, 82001, 1483, '睡前拉伸 15 分钟', '湖边瑜伽', 'https://picsum.photos/id/1016/800/450', '髋和胸椎打开即可。', 15, 60, 720, '2026-08-04 17:00:00'),
(2404, 82002, 1484, '高蛋白午餐模板', '营养员', 'https://picsum.photos/id/488/800/450', '鸡胸、杂粮饭、西兰花。', 0, 0, 510, '2026-08-05 17:00:00'),
(2405, 82001, 1485, '滨江骑行 40 公里', '风行', 'https://picsum.photos/id/73/800/450', '早高峰前出发，补给带水。', 120, 680, 330, '2026-08-06 17:00:00'),
(2406, 82002, 1486, '呼吸冥想 10 分钟', '止', 'https://picsum.photos/id/54/800/450', '4-7-8 呼吸，睡前做。', 10, 20, 410, '2026-08-07 17:00:00')
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `categoryId`=VALUES(`categoryId`);

INSERT INTO `Vehicle` (`id`,`userId`,`categoryId`,`title`,`author`,`cover`,`content`,`brand`,`viewCount`,`date`) VALUES
(2501, 82001, 1491, '紧凑型 SUV 对比', '车评社', 'https://picsum.photos/id/111/800/450', '空间、油耗、保修三项。', '多家', 1420, '2026-08-02 18:00:00'),
(2502, 82002, 1492, '三年准新代步车', '车行老李', 'https://picsum.photos/id/133/800/450', '本地一手，记录可查。', '日产', 680, '2026-08-03 18:00:00'),
(2503, 82001, 1493, '小保养套餐', '快保', 'https://picsum.photos/id/146/800/450', '机油机滤，预约减免等候。', '通用', 540, '2026-08-04 18:00:00'),
(2504, 82002, 1494, '科目二直角转弯', '驾校王', 'https://picsum.photos/id/180/800/450', '看右后视镜压线再打轮。', '驾考', 2100, '2026-08-05 18:00:00'),
(2505, 82001, 1495, '雨天高速注意事项', '老司机', 'https://picsum.photos/id/201/800/450', '拉大车距，少并线。', '通用', 760, '2026-08-06 18:00:00'),
(2506, 82002, 1496, '行车记录仪选购', '改装铺', 'https://picsum.photos/id/250/800/450', '前后双录，注意供电。', '配件', 430, '2026-08-07 18:00:00')
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `categoryId`=VALUES(`categoryId`);

INSERT INTO `Job` (`id`,`userId`,`categoryId`,`title`,`author`,`cover`,`content`,`company`,`salary`,`viewCount`,`date`) VALUES
(2601, 82001, 1501, '前端工程师', '星河科技', 'https://picsum.photos/id/0/800/450', '熟悉 TypeScript 与组件化。', '星河科技', '18-28k', 980, '2026-08-02 19:00:00'),
(2602, 82002, 1502, '电商运营', '南货铺', 'https://picsum.photos/id/20/800/450', '负责活动页与转化。', '南货铺', '10-16k', 640, '2026-08-03 19:00:00'),
(2603, 82001, 1503, '产品设计师', '青柠设计', 'https://picsum.photos/id/177/800/450', 'B 端表格与表单经验优先。', '青柠设计', '15-22k', 510, '2026-08-04 19:00:00'),
(2604, 82002, 1504, '少儿英语老师', '苗苗学堂', 'https://picsum.photos/id/24/800/450', '周末班，提供教案。', '苗苗学堂', '8-12k', 390, '2026-08-05 19:00:00'),
(2605, 82001, 1505, '暑期产品实习', '远帆', 'https://picsum.photos/id/1015/800/450', '协助调研与周报，可转正。', '远帆', '150/天', 870, '2026-08-06 19:00:00'),
(2606, 82002, 1506, '周末活动执行', '会务组', 'https://picsum.photos/id/180/800/450', '布置签到与物料，按场结算。', '会务组', '400/场', 220, '2026-08-07 19:00:00')
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `categoryId`=VALUES(`categoryId`);

INSERT INTO `House` (`id`,`userId`,`categoryId`,`title`,`author`,`cover`,`content`,`area`,`price`,`viewCount`,`date`) VALUES
(2701, 82001, 1511, '江景三期洋房', '方圆地产', 'https://picsum.photos/id/164/800/450', '低密，带花园，交房两年。', 128.00, 2680000.00, 760, '2026-08-02 20:00:00'),
(2702, 82002, 1512, '学区两房急售', '阿强', 'https://picsum.photos/id/122/800/450', '满五唯一，看房需预约。', 78.00, 2150000.00, 980, '2026-08-03 20:00:00'),
(2703, 82001, 1513, '近地铁精装单间', '翠苑管家', 'https://picsum.photos/id/201/800/450', '押一付三，可短租。', 28.00, 2800.00, 1540, '2026-08-04 20:00:00'),
(2704, 82002, 1514, '老房翻新实景', '木作', 'https://picsum.photos/id/1078/800/450', '拆除承重外的隔墙，重做收纳。', 89.00, 180000.00, 430, '2026-08-05 20:00:00'),
(2705, 82001, 1515, '原木风客厅', '软装工作室', 'https://picsum.photos/id/1068/800/450', '沙发与灯具清单可复用。', 0.00, 12600.00, 610, '2026-08-06 20:00:00'),
(2706, 82002, 1516, '园区临街旺铺', '招商部', 'https://picsum.photos/id/119/800/450', '展示面 8 米，可餐饮。', 96.00, 18000.00, 280, '2026-08-07 20:00:00')
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `categoryId`=VALUES(`categoryId`);

INSERT INTO `Beauty` (`id`,`userId`,`categoryId`,`title`,`author`,`cover`,`content`,`shop`,`price`,`viewCount`,`date`) VALUES
(2801, 82001, 1521, '设计师剪发', '青木造型', 'https://picsum.photos/id/64/800/450', '含洗发吹整，可改期。', '青木造型', 188.00, 420, '2026-08-02 21:00:00'),
(2802, 82002, 1522, '日式美甲套餐', '指尖', 'https://picsum.photos/id/1080/800/450', '固态甲油胶，约 90 分钟。', '指尖美甲', 158.00, 360, '2026-08-03 21:00:00'),
(2803, 82001, 1523, '补水护理 60 分钟', '澄光', 'https://picsum.photos/id/1015/800/450', '敏感肌友好，先做测试。', '澄光皮肤', 268.00, 210, '2026-08-04 21:00:00'),
(2804, 82002, 1524, '皮肤检测咨询', '医美顾问', 'https://picsum.photos/id/177/800/450', '仅咨询与方案，不含项目。', '澄光皮肤', 0.00, 180, '2026-08-05 21:00:00'),
(2805, 82001, 1525, '小团课普拉提', '形', 'https://picsum.photos/id/1016/800/450', '每班 6 人，需自备袜。', '形工作室', 98.00, 150, '2026-08-06 21:00:00'),
(2806, 82002, 1526, '男士理容套餐', '理', 'https://picsum.photos/id/91/800/450', '剪发+修面，工作日更空。', '理男士', 128.00, 190, '2026-08-07 21:00:00')
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `categoryId`=VALUES(`categoryId`);

INSERT INTO `Photo` (`id`,`userId`,`categoryId`,`title`,`author`,`cover`,`content`,`location`,`pictureList`,`viewCount`,`date`) VALUES
(2901, 82001, 1531, '黄昏窗边', '阿年', 'https://picsum.photos/id/64/800/450', '侧光人像，未加闪。', '工作室', '["https://picsum.photos/id/64/800/450","https://picsum.photos/id/65/800/450"]', 860, '2026-08-02 22:00:00'),
(2902, 82002, 1532, '雨后山脊', '远山', 'https://picsum.photos/id/1015/800/450', '云海只出现了十分钟。', '黄山', '["https://picsum.photos/id/1015/800/450","https://picsum.photos/id/1016/800/450"]', 1240, '2026-08-03 22:00:00'),
(2903, 82001, 1533, '早市人流', '街拍', 'https://picsum.photos/id/1011/800/450', '28mm，不打扰。', '湖滨', '["https://picsum.photos/id/1011/800/450"]', 540, '2026-08-04 22:00:00'),
(2904, 82002, 1534, '一碗面', '静物', 'https://picsum.photos/id/292/800/450', '窗光，深色背景。', '家里', '["https://picsum.photos/id/292/800/450"]', 410, '2026-08-05 22:00:00'),
(2905, 82001, 1535, '毕业礼跟拍', '活动组', 'https://picsum.photos/id/1016/800/450', '主舞台与家长席两条线。', '大学路', '["https://picsum.photos/id/1016/800/450","https://picsum.photos/id/1018/800/450"]', 720, '2026-08-06 22:00:00'),
(2906, 82002, 1536, '肤色与曲线', '后期课', 'https://picsum.photos/id/177/800/450', '只调曲线，不磨皮。', '教室', '["https://picsum.photos/id/177/800/450"]', 630, '2026-08-07 22:00:00')
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `categoryId`=VALUES(`categoryId`);

INSERT INTO `Note` (`id`,`userId`,`categoryId`,`title`,`author`,`cover`,`content`,`tag`,`viewCount`,`date`) VALUES
(3001, 82001, 1541, '周一产品评审纪要', 'Jan', 'https://picsum.photos/id/201/800/450', '结论：分类页先上，支付仍走独立服务。', '会议', 12, '2026-08-02 08:00:00'),
(3002, 82002, 1542, '本周发布清单', 'Lotus', 'https://picsum.photos/id/180/800/450', 'DDL、文案、回归三条必须打勾。', '待办', 8, '2026-08-03 08:00:00'),
(3003, 82001, 1543, 'APIJSON 场景备忘', 'Jan', 'https://picsum.photos/id/24/800/450', '适合内容与目录，不适合资金与对战。', '知识', 36, '2026-08-04 08:00:00'),
(3004, 82002, 1544, '七月月报草稿', 'Lotus', 'https://picsum.photos/id/20/800/450', '完成布局分类，下一期做导入校验。', '月报', 5, '2026-08-05 08:00:00'),
(3005, 82001, 1545, '周会文档模板', 'Jan', 'https://picsum.photos/id/0/800/450', '目标 / 进展 / 风险 / 求助。', '模板', 19, '2026-08-06 08:00:00'),
(3006, 82002, 1546, '联调值班约定', 'Lotus', 'https://picsum.photos/id/96/800/450', '出问题先看 Access，再看 Request.tag。', '协作', 14, '2026-08-07 08:00:00')
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `categoryId`=VALUES(`categoryId`);
