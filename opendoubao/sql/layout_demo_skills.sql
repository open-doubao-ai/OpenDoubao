...
(4005, 82001, 'news', '新闻资讯', 'News', 'News', 'news', '["news","headline","新闻","资讯","新闻资讯"]', '新闻稿件、栏目、阅读数。', '/skills/news.md', NULL, 1, 'online', NULL, NOW()),
(4006, 82001, 'info', '资讯公告', 'Notices', 'Notice', 'news', '["notice","bulletin","资讯公告","公告"]', '公告、制度；页面类型与新闻资讯合并。', '/skills/info.md', NULL, 1, 'online', NULL, NOW()),
...
(4009, 82001, 'books', '小说阅读', 'Novels', 'Book', 'article', '["book","ebook","novel","图书","图书阅读","小说"]', '小说书目、简介、出版社。', '/skills/books.md', NULL, 1, 'online', NULL, NOW()),
