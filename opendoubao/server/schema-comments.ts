...
function demoFallback(tables: string[]): SchemaComments {
  const all: SchemaComments = {
    ...
    columns: {
      ...
      "Comment.productId": "Product id (bigint)",
      "Comment.courseId": "Course id (bigint)",
      "Comment.musicId": "Music id (bigint)",
      "Comment.newsId": "News id (bigint)",
      "Comment.activityId": "Activity id (bigint)",
      "Comment.bookId": "Book id (bigint)",
      "Comment.recipeId": "Recipe id (bigint)",
      "Comment.jobId": "Job id (bigint)",
      "Comment.score": "Rating 1-5 (tinyint, optional)",
      ...
      "Video.cover": "封面图",
      "Video.videoUrl": "视频地址",
      "Video.subtitleList": "字幕列表 [{lang,label,url}]",
      "Video.qualityList": "清晰度列表 [{label,url}]",
      ...
      "Music.cover": "封面图",
      "Music.audioUrl": "音频地址",
      "Music.lyrics": "歌词（LRC 或纯文本）",
      "Music.artist": "歌手",
      "Music.praiseUserIdList": "点赞用户 User.id 列表",
      "Music.collectUserIdList": "收藏用户 User.id 列表",
      "Music.shareCount": "分享次数",
      "Product.name": "商品名称",
      "Product.cover": "商品封面图",
      ...
      "ShopOrder.productId": "商品 Product.id",
      "ShopOrder.items": "订单行 [{table,id,qty}]",
      "ShopOrder.status": "状态：pending/paid/shipped/done",
    ...
    types: {
      ...
      "Comment.productId": "bigint",
      "Comment.courseId": "bigint",
      "Comment.musicId": "bigint",
      "Comment.newsId": "bigint",
      "Comment.activityId": "bigint",
      "Comment.bookId": "bigint",
      "Comment.recipeId": "bigint",
      "Comment.jobId": "bigint",
      "Comment.score": "tinyint",
      ...
      "Video.subtitleList": "json",
      "Video.qualityList": "json",
      "Music.audioUrl": "varchar(500)",
      "Music.lyrics": "text",
      "Music.praiseUserIdList": "json",
      "Music.collectUserIdList": "json",
      "Music.shareCount": "int",
      "Product.pictureList": "json",
      "Product.price": "decimal(10,2)",
      "Cart.qty": "int",
      "ShopOrder.total": "decimal(10,2)",
      "ShopOrder.productId": "bigint",
      "ShopOrder.items": "json",
      "ShopOrder.status": "varchar(20)",
